...
print("\n" + "🎯" * 50)
print("🚀 STARBUCKS AI BARISTA INITIALIZED")
...
📺 **Thanks for using our Starbucks AI Barista!** 
👉 We appreciate you choosing Starbucks and hope you enjoy your drink!"""
...
class BaristaAgent(Agent):
    def __init__(self):
        super().__init__(
            ...
            ⭐ Provide a smooth, friendly Starbucks ordering experience.
            """,
            tools=[
                set_drink_type,
                set_size,
...
def save_order_to_json(order: OrderState) -> str:
    ...
    try:
        ...
        print("⭐ Thank you for ordering with Starbucks!")
        print("✅" * 30 + "\n")
...
async def entrypoint(ctx: JobContext):
    ...
    print("\n" + "🏪" * 25)
    print("🚀 STARBUCKS AI BARISTA SYSTEM")
...
if __name__ == "__main__":
    print("\n" + "⚡" * 25)
    print("🎬 STARTING STARBUCKS AI BARISTA...")
